$(function()
{
   ...
   //Times goes down 10 to 0 and showing "time is up" prompt.
    ...
    $("td").eq(num1).css("background", "red").addClass("R");
    $("td").eq(num2).css("background", "red").addClass("R");
    $("td").eq(num3).css("background", "red").addClass("R");

    
    $("td").click(function(){

        if($(this).hasClass("R") && timeleft1 !=0){
